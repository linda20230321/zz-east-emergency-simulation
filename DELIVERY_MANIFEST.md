...
本次补丁同步包含关键步骤聚焦视图、路径推荐独立侧栏、底图内容层110%默认缩放、底图框全宽适配、疏散/回流路线箭头、可拖拽且不越界的广播与导向屏气泡，以及对应测试与文档。
...
发布前执行`npm test`。该命令会校验版本与文档同步、生产构建、15个时间节点、37,000人守恒、精简设备范围、四出口动态路线切换、改进型A*、六路监控同源、人员范围、楼层人数、站台乘车联动、底图独立缩放和全宽适配。
