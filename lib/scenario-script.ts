...
export const scriptSteps: ScriptStep[] = [
  ...
  { minute: 2, time: "09:02", title: "启动Ⅰ级应急响应", location: "生产指挥中心", process: "集团公司调度所下达Ⅰ级响应命令，六个应急小组接令并到岗。", roles: [
    ...
    { group: "后勤保障组", person: "角振中", post: "组长", duty: "组织餐食及现场后勤协调" },
    { group: "站区协调组", person: "何冉", post: "组长", duty: "协调站区设备、公安、交警和志愿者" }
  ], actions: [] },
  { minute: 5, time: "09:05", title: "各应急小组到岗与设备联动", location: "全站", process: "六个应急小组逐项汇报到岗，完成进站限流、换乘直梯关闭、候车分区和动态路线预计算。", roles: [
    ...
    { group: "客运组织组", person: "程冠楠/李予霞", post: "一层疏散/检票口负责人", duty: "关闭换乘直梯，组织1—2小时及2小时以上旅客分区" },
    { group: "站区协调组", person: "席宇/潘晓", post: "客运业务科/设备科", duty: "配备喇叭和LED屏，协调电梯、安检及现场秩序" },
    { group: "路地联动组", person: "地铁、公交、出租、公安、东站办、武警", post: "联动单位", duty: "限制到站客流并协同现场秩序" }
  ], actions: [
    ...
    { device: "一层西广场电子显示屏", operation: "切换疏散信息", owner: "程冠楠/席宇" }
  ...
  { minute: 13, time: "09:13", title: "综控计划应急处置", location: "综控计划室", process: "核对列车运行信息，统计接续需求并联系G1163次列车疏散100名旅客。", roles: [
    { group: "综控计划", person: "吴丽媛", post: "负责人", duty: "组织综控和计划按分工处置" },
    { group: "综控", person: "魏芳园", post: "指挥员", duty: "核对68列晚点、6列停运信息，联系G1163次列车长" },
    { group: "计划室", person: "郭杨", post: "计划员", duty: "维护晚点30分钟以上列车原退定义并形成统计表" }
  ], actions: [{ device: "广播系统", operation: "对晚点15分钟以上列车播放致歉广播", owner: "魏芳园" }] },
  ...
  { minute: 21, time: "09:21", title: "正南进站口限流疏散", location: "正南进站口→一层西广场", process: "正南、正北只允许两小时内旅客进站，两小时以外旅客转移至一层西广场。", roles: [
    ...
    { group: "验证岗位", person: "马瑞/田心雨", post: "西南/正南验证值班员", duty: "引导两小时外旅客下行" }
  ], actions: [{ device: "正南外小喇叭", operation: "播放限时候车宣传", content: twoHourNotice, owner: "田心雨" }, { device: "正南内侧喇叭", operation: "播放进站准备提示", content: "各位旅客，请提前准备好您的身份证做好进站准备，持临时身份证的旅客由最左侧人工验证口验证，有携带液体的旅客做好试喝准备。", owner: "田心雨" }] },
  { minute: 23, time: "09:23", title: "1—2小时及2小时以上旅客分区", location: "B8/B9及B4/B5检票口后方", process: "客运员和志愿者按车次将旅客引导至两个临时候车区，四条路线根据密度持续重算。", roles: [{ group: "客运组织组", person: "陈洋", post: "客运员", duty: "引导1—2小时内旅客至B8/B9后方" }, { group: "客运组织组", person: "孙佳", post: "客运员", duty: "引导2小时以上旅客至B4/B5后方" }], actions: [] },
  { minute: 26, time: "09:26", title: "第八售票处退改签组织", location: "第八售票处", process: "增开50、51号窗口，电子屏和手持喇叭同步发布退票改签信息。", roles: [{ group: "售票应急组", person: "郭艳红/任欣韫", post: "售票值班员/宣传员", duty: "增开窗口并解释退票改签政策" }], actions: [{ device: "50、51号售票窗口", operation: "打开并显示晚点、停运列车退票窗口", owner: "郭艳红" }, { device: "第八售票处电子大屏", operation: "显示停运退票公告", content: refundNotice, owner: "郭艳红" }, { device: "第八售票处手持喇叭", operation: "宣传退票改签", content: "已购买停运列车车票的旅客，可在30日内通过12306手机客户端或全国任意车站售票处免费办理退票手续。已购买晚点30分钟以上列车车票的旅客，可在列车实际发车时间前通过12306手机客户端免费办理退票手续。", owner: "任欣韫" }] },
  { minute: 29, time: "09:29", title: "密度驱动动态分流", location: "候车室→一层西广场", process: "改进型A*融合曼哈顿距离、实时密度和转向代价，持续优化正南、正北、西南、西北四条路线。", roles: [{ group: "检票口组织", person: "徐悦/崔扬/冯桦", post: "客运员/值班员", duty: "按系统当前推荐路线组织下行疏散" }], actions: [{ device: "B4/B5集结区喇叭", operation: "播报当前推荐出口", content: "请旅客按照大屏显示的实时推荐出口有序前往一层西广场。", owner: "检票口组织" }], monitorIds: ["CAM-01", "CAM-02", "CAM-03", "CAM-04", "CAM-05", "CAM-06"] },
  { minute: 32, time: "09:32", title: "西南进站口只出不进", location: "西南进站口及1F/2F/3F扶梯", process: "西南进站口保持只出不进，四条下行路线继续按实时密度动态分流。", roles: [{ group: "扶梯值守", person: "马瑞/蒋薇薇/梁苡菲", post: "3F/2F/1F西南扶梯值守", duty: "逐层宣传、限流并引导旅客前往一层西广场" }], actions: [{ device: "3F/2F/1F西南扶梯小喇叭", operation: "同步宣传", content: "旅客您好，请根据实时推荐路线有序前往一层西广场候车区。", owner: "马瑞/蒋薇薇/梁苡菲" }] },
  { minute: 35, time: "09:35", title: "一层西广场候车与分批回流", location: "一层西广场候车区", process: "南北分区候车，按G806、G1808、G51的开检状态分批经中部通道或绿色通道进站。", roles: [
    ...
    { group: "带队岗位", person: "李静", post: "带队人员", duty: "组织指定车次旅客进站" }
  ], actions: [
    ...
    { device: "西广场外侧通道喇叭", operation: "基础候车宣传", content: "应急演练通知：旅客朋友们，请按车次信息找到您所乘坐列车的候车位置，并耐心等候，感谢您的配合。", owner: "张琛" },
    ...
    { device: "西广场中部通道喇叭", operation: "G51进站宣传", content: "乘坐G51的旅客请跟随工作人员有序进站。", owner: "绿色通道带队人员" }
  ] },
  { minute: 46, time: "09:46", title: "现场情况汇报", location: "二层平台", process: "候车厅旅客控制在约2万人，一层西广场秩序正常，客运车间向站级指挥报告。", roles: [{ group: "客运车间", person: "李予霞/程冠楠/闫林", post: "现场及车间负责人", duty: "报告候车厅和西广场疏散情况" }], actions: [] },
...
export function getScriptRuntimeStep(minute: number): ScriptStep {
  ...
  return {
    ...
    process: phase === "基础候车"
      ...
      : phase === "G806"
        ? "综控通知G806停靠2道，二层与西广场同步宣传，李静经中部通道带队进站。"
        : phase === "G1808"
          ? "候车厅约18000人，G1808正点放行，二层与西广场同步宣传并带队进站。"
