...
export function getDevices(minute: number): DeviceState[] {
  ...
  const allDevices: DeviceState[] = [
    ...
    device("GATE_S", "正南实名制核验闸机", "gate", "3F", 52, 30.5, emergency ? "限制两小时以外进站" : "开放", emergency ? "warning" : "normal", "只允许开车前两小时以内旅客进站。", 1, "3F正南进站口", "王瑞/田心雨", "09:05/09:21"),
    device("GATE_N", "正北实名制核验闸机", "gate", "3F", 52, 14, emergency ? "限制两小时以外进站" : "开放", emergency ? "warning" : "normal", "只允许开车前两小时以内旅客进站。", 1, "3F正北进站口", "王瑞", "09:05"),
    ...
    ...portableDevices,
    device("DSP_S", "正南进站大屏", "display", "3F", 55, 30, activeDisplay(19) ? "显示停运公告" : "车次信息", activeDisplay(19) ? "critical" : "normal", SCRIPT_REFUND_NOTICE, 1, "3F正南进站口", "文化传媒", "09:19"),
    device("DSP_N", "正北进站大屏", "display", "3F", 55, 14, activeDisplay(19) ? "显示停运公告" : "车次信息", activeDisplay(19) ? "critical" : "normal", SCRIPT_REFUND_NOTICE, 1, "3F正北进站口", "文化传媒", "09:19"),
